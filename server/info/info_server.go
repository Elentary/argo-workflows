...
func (i *infoServer) GetInfo(context.Context, *infopkg.GetInfoRequest) (*infopkg.InfoResponse, error) {
	...
	return &infopkg.InfoResponse{
		...
		Modals:            modals,
		NavColor:          i.navColor,
		LinksOpenInNewTab: i.linksOpenInNewTab,
	}, nil
}
...
func NewInfoServer(managedNamespace string, links []*wfv1.Link, columns []*wfv1.Column, navColor string, linksOpenInNewTab bool) infopkg.InfoServiceServer {
	return &infoServer{managedNamespace, links, columns, navColor, linksOpenInNewTab}
}
